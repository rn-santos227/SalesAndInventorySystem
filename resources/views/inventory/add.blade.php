            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <div class="form-group" id="s_item_code">
                  ...
                  <div class="col-sm-7">
                    <input type="text" class="form-control" id="s_item_code" name="s_item_code" placeholder="Enter Product Code (Barcode/QR Code)">
                  </div>
                </div>
                <div class="form-group" id="s_item_category_id">
                  ...
                  <div class="col-sm-7">
                    <section class="flexbox">
                      <div class="stretch">
                        <select class="form-control" id="s_item_category_id" name="s_item_category_id">
                ...
                <div class="form-group" id="s_item_supplier_id">
                  ...
                  <div class="col-sm-7">
                    <section class="flexbox">
                      <div class="stretch">
                        <select class="form-control" id="s_item_supplier_id" name="s_item_supplier_id">
                ...
                <div class="form-group" id="s_quantity">
                  ...
                  <div class="col-sm-7">
                    <input type="number" class="form-control" id="s_quantity" name="s_quantity" value = "1" min="1" placeholder="Enter Product Quantity">
                  </div>
                </div>
                <div class="form-group" id="s_price">
                  <label class="control-label col-sm-4"><i class="fa fa-asterisk fa-sm red"></i> Product Price:</label>
                  <div class="col-sm-7">
                    <input type="text" class="form-control" id="s_price" name="s_price" value = "1" min="1" placeholder="Enter Product Price">
                  </div>
                </div>
              </div>
